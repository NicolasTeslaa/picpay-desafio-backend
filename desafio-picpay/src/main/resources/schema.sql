CREATE TABLE IF NOT EXISTS WALLETS ( ID SERIAL PRIMARY KEY, FULL_NAME VARCHAR(100), CPF BIGINT, EMAIL VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS TRANSACTIONS (
    ID SERIAL PRIMARY KEY, PAYERI INT, PAYEE INT, "VALUE" DECIMAL(10, 2),
